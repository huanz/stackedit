...
(function () {
    ...
    var defaultsStrings = {
        bold: "粗体 <strong> Ctrl/Cmd+B",
        boldexample: "粗体文本",

        italic: "斜体 <em> Ctrl/Cmd+I",
        italicexample: "斜体文本",

        link: "超链接 <a> Ctrl/Cmd+L",
        linkdescription: "此处输入链接的描述",
        linkdialog: "<p><b>输入超链接</b></p><p>http://example.com/ \"可选标题\"</p>",

        quote: "段落引用 <blockquote> Ctrl/Cmd+Q",
        quoteexample: "段落引用",

        code: "代码样例 <pre><code> Ctrl/Cmd+K",
        codeexample: "此处输入代码",

        image: "图片 <img> Ctrl/Cmd+G",
        imagedescription: "此处输入图片的描述",
        imagedialog: "<p><b>插入图片</b></p><p>http://example.com/images/diagram.jpg \"可选标题\"<br><br>Need <a href='http://www.google.com/search?q=free+image+hosting' target='_blank'>需要免费的图片主机？</a></p>",
